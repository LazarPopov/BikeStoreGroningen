import { neighborhoodPages as groningenLocalAreas } from "@/data/neighborhood-pages";
...
export const bikesGroningenConfig: SiteConfig = {
  ...
  heroImagePath: "/images/bikes-groningen-hero.jpg",
  ...
  localAreas: groningenLocalAreas,
